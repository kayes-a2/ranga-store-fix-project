...
const loadProducts = () => {
  ...
  // get dara from api (function call)
  showProducts(data);
};
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
                    <div class="single-product py-3">
                    <div>
                    <img class="product-image" src=${image}></img>
                    </div>
                    <h3>${product.title}</h3>
                    <p>Category: ${product.category}</p>
                    <h6>Rating: ${product.rating.rate}<i class="fas fa-star       text-warning"></i> <i class="fas fa-star text-warning"></i> <i class="fas fa-star text-warning"></i> <i class="fas fa-star text-warning"></i> <i class="fas fa-star-half text-warning "></i></h6>
                    <h6>Total review: ${product.rating.count}</h6>
...
//function of api data call itself for show data on ui
loadProducts();